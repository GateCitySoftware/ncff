class ActivationsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @activation.save
        format.html { redirect_to activation_url(@activation), notice: "Activation was successfully created." }
  ...
  def update
    respond_to do |format|
      if @activation.update(activation_params)
        format.html { redirect_to activation_url(@activation), notice: "Activation was successfully updated." }
  ...
  private
    ...
    def activation_params
      params.require(:activation).permit(:name, :description, :image, :website, :social_media_links)
    end
end
