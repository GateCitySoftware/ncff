...
ActiveRecord::Schema[7.1].define(version: 20_240_716_150_810) do
  ...
  create_table 'embedded_contents', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[embeddable_type embeddable_id], name: 'index_embedded_contents_on_embeddable'
  end
  ...
  create_table 'external_links', force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.uuid 'linkable_id'
    t.index %w[linkable_type linkable_id], name: 'index_external_links_on_linkable'
  end
  ...
  create_table 'tagged_items', force: :cascade do |t|
    ...
    t.index %w[taggable_type taggable_id], name: 'index_tagged_items_on_taggable'
  end
