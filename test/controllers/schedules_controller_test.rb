...
class SchedulesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create schedule" do
    assert_difference("Schedule.count") do
      post schedules_url, params: { schedule: { date: @schedule.date, name: @schedule.name } }
    end
  ...
  test "should update schedule" do
    patch schedule_url(@schedule), params: { schedule: { date: @schedule.date, name: @schedule.name } }
