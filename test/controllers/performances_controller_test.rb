...
class PerformancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create performance" do
    assert_difference("Performance.count") do
      post performances_url, params: { performance: { artist_id: @performance.artist_id, description: @performance.description, end_time: @performance.end_time, is_headline: @performance.is_headline, stage_id: @performance.stage_id, start_time: @performance.start_time } }
    end
  ...
  test "should update performance" do
    patch performance_url(@performance), params: { performance: { artist_id: @performance.artist_id, description: @performance.description, end_time: @performance.end_time, is_headline: @performance.is_headline, stage_id: @performance.stage_id, start_time: @performance.start_time } }
